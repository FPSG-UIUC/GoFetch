                              ...
                              BN_MONT_CTX *in_mont)
{
    ...
    // 2^window (will be stored later, once we determine the value of window)
    int numPowers;
    // Used to store 2^i for i = 0 to 2^window - 1
...
#endif
    {
        /*Dump out target arguments address (DMP)*/
        printf("tmp addr: %p \n", tmp.d);
